...
class CurtainWall(ArchComponent.Component):
    ...
    def setProperties(self,obj):
        ...
        # TODO By Paul 2024.11.10 (Copy ArchWall)
        if not "ArchSketchData" in pl:
            obj.addProperty("App::PropertyBool","ArchSketchData","CurtainWall",QT_TRANSLATE_NOOP("App::Property","Use Base ArchSketch (if used) data (e.g. widths, aligns, offsets) instead of Wall's properties"))
            obj.ArchSketchData = True

        # TODO By Paul 2024.11.10 - Re-Brand 'ArchSketchEdges' from 'OverrideEdges' ? TODO
        #if not "ArchSketchEdges" in pl:
        #    obj.addProperty("App::PropertyStringList","ArchSketchEdges","CurtainWall",QT_TRANSLATE_NOOP("App::Property","Selected edges (or group of edges) of the base Sketch/ArchSketch, to use in creating the shape of this Arch Wall (instead of using all the Base Sketch/ArchSketch's edges by default).  Input are index numbers of edges or groups.  Disabled and ignored if Base object (ArchSketch) provides selected edges (as Wall Axis) information, with getWallBaseShapeEdgesInfo() method.  [ENHANCEMENT by ArchSketch] GUI 'Edit Wall Segment' Tool is provided in external SketchArch Add-on to let users to (de)select the edges interactively.  'Toponaming-Tolerant' if ArchSketch is used in Base (and SketchArch Add-on is installed).  Warning : Not 'Toponaming-Tolerant' if just Sketch is used."))

        # TODO By Paul 2024.11.10 (Copy ArchWall 2024.9.8)
        if not hasattr(obj,"ArchSketchPropertySet"):
            obj.addProperty("App::PropertyEnumeration","ArchSketchPropertySet","CurtainWall",QT_TRANSLATE_NOOP("App::Property","Select User Defined PropertySet to use in creating variant shape, layers of the Arch Wall with same ArchSketch "))
    ...
    # TODO By Paul 2024.11.10 (Copy ArchWall 2024.9.15)
    ...
    def onDocumentRestored(self,obj):
        ...
        # TODO By Paul 2024.9.15 (Copy ArchWall 2024.9.15 - 2024.7.1)
    ...
    def onChanged(self,obj,prop):
        ...
        # TODO By Paul 2024.11.10 (Copy ArchWall 2024.9.22)
    ...
    def execute(self,obj):
        ...
        # TODO By Paul 2024.11.10 (Copy ArchWall Add propertySet 2024.9.22)
        # PropertySet support
